import { MenuItem, Select,InputAdornment, Divider } from '@mui/material';
  ...
  return (
    <div>
      <div className="path-transaction flex p-4">
        <p className='text-[#B7B7B7] cursor-pointer' onClick={()=>navigate('/transaction-history')}>Transaction history / </p> <span className='text-[#6F6F6F]'>Akash Srivastav</span>
      </div>
      <div className="transaction-user bg-[#F3F3F3] p-8">
        ...
        <div className="continent w-[65%] px-8">
            ...
            <div className='flex justify-between'>
              ...
              <p><CurrencyRupeeIcon fontSize=''/> 81.00</p>
            </div>
            ...
            <div className="path-amount flex justify-between py-4">
              <p>paid Amount</p>
              <p><CurrencyRupeeIcon fontSize=''/> 181.00</p>
            </div>
        </div>
        </div>
      </div>
